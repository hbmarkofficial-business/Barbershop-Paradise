          ...
          <AnimateOnScroll animation="slide-right">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Landgrabenstraße 40, 90443 Nürnberg
                  </p>
                </div>
              </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button variant="goldOutline" size="xl" asChild>
                <a href="tel:017680296280">Jetzt anrufen</a>
              </Button>
            </div>
          </AnimateOnScroll>
          ...
          <AnimateOnScroll animation="slide-left">
            <div className="relative">
              <div className="aspect-square lg:aspect-[4/5] rounded-sm overflow-hidden border border-border">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d41506.905246505325!2d11.03716239385272!3d49.44328504065481!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x479f5704f59d085b%3A0x88bdcb164f4b3d63!2sBarbershop%20Paradise%20-%20N%C3%BCrnberg!5e0!3m2!1sde!2sde!4v1769377574552!5m2!1sde!2sde"
                  width="100%"
                  height="100%"
                  ...
                  title="Standort Barbershop Paradise – Nürnberg"
                />
              </div>
